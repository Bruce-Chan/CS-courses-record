...
public class TestUnit{
    ...
    public void testJoin1(){
        Column<Integer> c1 = new Column<>("x", "integer");
        c1.add(2);
        c1.add(8);
        c1.add(13);

        Column<Integer> c2 = new Column<>("y", "integer");
        c2.add(5);
        c2.add(3);
        c2.add(7);
        ...
        Column<Integer> c3 = new Column<>("x", "integer");
        c3.add(2);
        c3.add(8);
        c3.add(10);

        Column<Integer> c4 = new Column<>("z", "integer");
        c4.add(4);
        c4.add(9);
        c4.add(1);
        ...
        Column<Integer> c5 = new Column<>("x", "integer");
        c5.add(2);
        c5.add(8);

        Column<Integer> c6 = new Column<>("y", "integer");
        c6.add(5);
        c6.add(3);

        Column<Integer> c7 = new Column<>("z", "integer");
        c7.add(4);
        c7.add(9);
    ...
    public void TestEval(){
        String line =  "create table team (Name string, Wins integer)";
        Database db = new Database();
        String result = db.transact(line);
        String except = "Name string,Wins integer\n";
